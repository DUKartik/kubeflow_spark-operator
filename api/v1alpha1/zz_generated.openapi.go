...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectServerStatus": schema_spark_operator_v2_api_v1alpha1_SparkConnectServerStatus(ref),
		"github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectSpec":         schema_spark_operator_v2_api_v1alpha1_SparkConnectSpec(ref),
		"github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectStatus":       schema_spark_operator_v2_api_v1alpha1_SparkConnectStatus(ref),
		"github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkPodSpec":             schema_spark_operator_v2_api_v1alpha1_SparkPodSpec(ref),
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "DynamicAllocation contains configuration options for dynamic allocation.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"initialExecutors": {
						SchemaProps: spec.SchemaProps{
							Description: "InitialExecutors is the initial number of executors to request. If .spec.executor.instances is also set, the initial number of executors is set to the bigger of that and this option.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					...
					"shuffleTrackingTimeout": {
						SchemaProps: spec.SchemaProps{
							Description: "ShuffleTrackingTimeout controls the timeout in milliseconds for executors that are holding shuffle data if shuffle tracking is enabled (true by default if dynamic allocation is enabled).",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
...
func schema_spark_operator_v2_api_v1alpha1_ExecutorSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ExecutorSpec is specification of the executor.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"cores": {
						SchemaProps: spec.SchemaProps{
...
func schema_spark_operator_v2_api_v1alpha1_ServerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ServerSpec is specification of the Spark connect server.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"cores": {
						SchemaProps: spec.SchemaProps{
...
func schema_spark_operator_v2_api_v1alpha1_SparkConnect(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectSpec", "github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectStatus", metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_spark_operator_v2_api_v1alpha1_SparkConnectList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SparkConnectList contains a list of SparkConnect.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnect"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnect", metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_spark_operator_v2_api_v1alpha1_SparkConnectServerStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_spark_operator_v2_api_v1alpha1_SparkConnectSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"image": {
						SchemaProps: spec.SchemaProps{
							Description: "Image is the container image for the driver, executor, and init-container. Any custom container images for the driver, executor, or init-container takes precedence over this.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"sparkConf": {
						SchemaProps: spec.SchemaProps{
							Description: "SparkConf carries user-specified Spark configuration properties as they would use the \"--conf\" option in spark-submit.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
					...
					"server": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/kubeflow/spark-operator/v2/api/v1alpha1.ServerSpec"),
						},
					},
					"executor": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/kubeflow/spark-operator/v2/api/v1alpha1.ExecutorSpec"),
						},
					},
					"dynamicAllocation": {
						SchemaProps: spec.SchemaProps{
							Description: "DynamicAllocation configures dynamic allocation that becomes available for the Kubernetes scheduler backend since Spark 3.0.",
							Ref:         ref("github.com/kubeflow/spark-operator/v2/api/v1alpha1.DynamicAllocation"),
						},
					},
				},
				Required: []string{"sparkVersion", "server", "executor"},
			},
		},
		Dependencies: []string{
...
func schema_spark_operator_v2_api_v1alpha1_SparkConnectStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"server": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectServerStatus"),
						},
					},
					"executors": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectServerStatus", metav1.Condition{}.OpenAPIModelName(), metav1.Time{}.OpenAPIModelName()},
	}
}

func schema_spark_operator_v2_api_v1alpha1_SparkPodSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SparkPodSpec defines common things that can be customized for a Spark driver or executor pod.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"cores": {
						SchemaProps: spec.SchemaProps{
...
func schema_k8sio_api_core_v1_HTTPGetAction(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1.HTTPHeader{}.OpenAPIModelName(), intstr.IntOrString{}.OpenAPIModelName()},
	}
}
...
func schema_k8sio_api_networking_v1_IngressBackend(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1.TypedLocalObjectReference{}.OpenAPIModelName(), networkingv1.IngressServiceBackend{}.OpenAPIModelName()},
	}
}
